...
deletion, and rename-replacement commit boundary prove that interruptions
preserve either a valid file or orphan-only space leakage rather than
cross-linked live data.
