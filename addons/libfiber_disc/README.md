...
This library and its RAM/VRAM examples are included in this complete fiber
bundle. Use the provider selected by [the bundle guide](../../FIBER-BUNDLE.md);
no additional fiber branch checkout is needed. The adapter itself is not a
runtime and never selects or starts the Service Executor.
