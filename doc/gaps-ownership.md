...
The complete `pr/core-fibers` and `addon/fiber-service-sh4zam` SDK bundles
already include this direct-access code, the adapter and examples; users of
those bundles do not need to check out any extra topic branch. The topic
names above describe contribution ownership, not installation steps.
