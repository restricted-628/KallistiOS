...
| Sound output robustness | AICA queue, allocator, stream, effect, and SPU services | Cumulative branch base complete | Wider synchronized start needs firmware coordination |
