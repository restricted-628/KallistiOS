...
char scrolly[] =
    ...
    "\0"
    "This program and the other demos\0"
    "on my site use KallistiOS,\0"
    "the Cryptic Allusion operating\0"
    "system for the Dreamcast.\0"
    "\0"
    "\r\0"
    ...
    "Dreamcast hardware team [we\0"
    "love this machine, sorry it\0"
    "didn't work out for you].\0"
    "\0"
